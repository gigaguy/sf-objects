({
    ...
    save : function(component, event) {
        ...
        alert('TQBCPWizardAddAttachHelper: Save Function: Please choose a file before attempting to save.');
        return;
        }

         if (file.size > this.MAX_FILE_SIZE) {
            alert('TQBCPWizardAddAttachHelper: Save Function:File size cannot exceed ' + this.MAX_FILE_SIZE + ' bytes.\n' +
    ...
    uploadChunk : function(component, file, fileContents, fromPos, toPos, attachId) {
        ...
        var selectedContentType = component.find("InputSelectDynamic").get("v.value");
 		console.log('TQBCPWizardAddAttachHelper: uploadChunk Function: component.get("v.candPackage.Id"): ' + component.get("v.candPackage.Id"));
        console.log('TQBCPWizardAddAttachHelper: uploadChunk Function: file : ' + file);
       // console.log('TQBCPWizardAddAttachmentHelper: uploadChunk Function: fileContents : ' + fileContents);
		console.log('TQBCPWizardAddAttachHelper: uploadChunk Function: fromPos: ' + fromPos);
        console.log('TQBCPWizardAddAttachHelper: uploadChunk Function: toPos : ' + toPos);
		console.log('TQBCPWizardAddAttachHelper: uploadChunk Function: attachId: ' + attachId);
